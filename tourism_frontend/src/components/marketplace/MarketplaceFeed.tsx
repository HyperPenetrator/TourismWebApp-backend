...
export const MarketplaceFeed = () => {
  ...
  const { items, prependItem, isLoading } = useMarketplaceItems();
    ...
    <div className="w-full relative">
      ...
      <AnimatePresence mode="wait">
        {showSkeleton ? (
          ...
          <div key="grid" className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <motion.div 
            ...
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
            className="col-span-full py-20 flex flex-col items-center justify-center text-slate-300 dark:text-white/20 border-2 border-dashed border-slate-200 dark:border-white/5 rounded-3xl"
          >
