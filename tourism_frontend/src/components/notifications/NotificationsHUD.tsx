...
export const NotificationsHUD = () => {
  const { notifications, markRead } = usePersonalNotificationsSSE();
    ...
    <div className="w-full relative px-4">
      ...
      <div className="flex flex-col gap-3">
        ...
        {notifications.length === 0 && (
          <div className="py-20 flex flex-col items-center justify-center text-slate-300 dark:text-white/20">
